...
class SetAfkCheckDurationCommand extends discord_akairo_1.Command {
    constructor() {
    ...
    exec(message, args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            sendmessage_1.default(message.channel, `Successfully changed AFK check duration for ${channelMonitor.name} to ${pretty_ms_1.default(args.afkCheckDuration)}!`);
        });
    }
}
exports.default = SetAfkCheckDurationCommand;
